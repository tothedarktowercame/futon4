...
- Metadata scholium :: A nema paired 1â1 with an article, caching backlinks, labels, and indexes.
...
- Entities â article nemas with derived identifiers.
- Relations â 2-end events (:hx/*) between nemas.
- Scholia â events and/or metadata nemas attached to articles.
- Inclusion / clusion / provenance â multi-end events with appropriate :role values.
