...
ffmpeg -hide_banner -y \
  ...
  -filter_complex "
    ...
    [3:a]aformat=channel_layouts=stereo,highpass=f=200, acompressor=threshold=-22dB:ratio=2:attack=10:release=150, volume=0.85,
         pan=stereo|c0=0.8*c0+0.2*c1|c1=0.2*c0+0.8*c1[harp];

    [v1][v2][ba][harp]amix=inputs=4:normalize=0[m];
