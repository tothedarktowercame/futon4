...
# 1) Rough mix with a natural center for the vocal/piano capture and a
#    slightly wider accordion/banjo frame.
ffmpeg -hide_banner -y \
  -i "$t1" -i "$t2" -i "$t3" -i "$t4" \
  -filter_complex "
    [0:a]highpass=f=80,  acompressor=threshold=-20dB:ratio=2:attack=20:release=200, volume=1.14, pan=stereo|c0=c0|c1=c0[v];
    [1:a]highpass=f=90,  lowpass=f=9000, acompressor=threshold=-22dB:ratio=2:attack=15:release=180, volume=0.94, pan=stereo|c0=0.60*c0|c1=0.40*c0[pL];
    [2:a]highpass=f=180, acompressor=threshold=-22dB:ratio=2:attack=10:release=150, volume=0.90, pan=stereo|c0=0.40*c0|c1=0.60*c0[aR];
    [3:a]highpass=f=120, lowpass=f=9200, acompressor=threshold=-22dB:ratio=2:attack=14:release=170, volume=0.92, pan=stereo|c0=0.68*c0|c1=0.32*c0[bL];
    [v][pL][aR][bL]amix=inputs=4:normalize=0[m];
