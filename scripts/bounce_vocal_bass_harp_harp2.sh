...
# Track1: vocals
# Track2: bass
# Track3: harp1 (higher register, trumpet-ish)
# Track4: harp2 (lower register, sax-ish)
#
# Mild stereo width: harp1 slightly left, harp2 slightly right.
...
ffmpeg -hide_banner -y \
  ...
  -filter_complex "
    ...
    [1:a]highpass=f=40,  lowpass=f=4000, acompressor=threshold=-18dB:ratio=2.5:attack=25:release=250, volume=1.05, pan=stereo|c0=c0|c1=c0[ba];
    [2:a]highpass=f=200, lowpass=f=7000, acompressor=threshold=-22dB:ratio=2:attack=12:release=180,
         equalizer=f=3000:t=q:w=1.0:g=2, volume=0.95, pan=stereo|c0=0.6*c0|c1=0.4*c0[h1];
    [3:a]highpass=f=160, lowpass=f=6000, acompressor=threshold=-22dB:ratio=2:attack=12:release=180,
         equalizer=f=1200:t=q:w=1.0:g=2, volume=0.95, pan=stereo|c0=0.4*c0|c1=0.6*c0[h2];
    [v][ba][h1][h2]amix=inputs=4:normalize=0[m];
