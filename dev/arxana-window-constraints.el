...
(defun arxana-window-constraints--define-relations ()
  ...
  (unless arxana-window-constraints--relations-defined
    ...
    (reazon-defrel arxana-window-constraints--two-windowo (all left right)
      (reazon-== all `(,left ,right)))
    (reazon-defrel arxana-window-constraints--three-windowo (all left mid right)
      (reazon-== all `(,left ,mid ,right)))
(reazon-defrel arxana-window-constraints--window-buffero (wininfo buffer)
    ...
    (reazon-defrel arxana-window-constraints--scholium-layouto
        (all code-buf source-buf display-buf ok)
      (reazon-conde
       ((reazon-fresh (left right)
          (arxana-window-constraints--two-windowo all left right)
       ...
       ((reazon-fresh (left mid right)
          (arxana-window-constraints--three-windowo all left mid right)
